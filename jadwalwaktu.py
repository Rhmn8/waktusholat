...
{lw}AUTHOR   : aulia rahman{lg}
{lw}GITHUB   : github.com/Rhmn8{lg}
{lw}WHATSAPP : 085821676621{lg}
...
def update():
      ...
      try:
            get('https://github.com/Rhmn8/waktusholat')
      except requests.exceptions.ConnectionError:
      ...
      sp.call(['cd .. && git clone https://github.com/Rhmn8/waktusholat'],shell=True, stdout=sp.DEVNULL,stderr=sp.STDOUT)
...
{lg}Versi       : {lw}3.8 (update: 13 Desember 2021, 20:28PM)
{lg}Tanggal     : {lw}13 Desember 2021, 20:28PM
{lg}Author      : {lw}Aulia Rahman
...
{lg}NB          : {lw}Manusia nggak ada yang sempurna,
              ...
              ke :  - https://www.facebook.com/profile.php?id=100049773491322
                    - https://www.instagram.com/@rahman_nayyers''')
